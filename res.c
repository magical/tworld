...
enum {
    ...
    RES_SND_BASE,
    RES_SND_CHIP_LOSES		= RES_SND_BASE + SND_CHIP_LOSES,
    RES_SND_CHIP_WINS		= RES_SND_BASE + SND_CHIP_WINS,
    RES_SND_TIME_OUT		= RES_SND_BASE + SND_TIME_OUT,
    RES_SND_TIME_LOW		= RES_SND_BASE + SND_TIME_LOW,
    RES_SND_DEREZZ		= RES_SND_BASE + SND_DEREZZ,
    RES_SND_CANT_MOVE		= RES_SND_BASE + SND_CANT_MOVE,
    RES_SND_IC_COLLECTED	= RES_SND_BASE + SND_IC_COLLECTED,
    RES_SND_ITEM_COLLECTED	= RES_SND_BASE + SND_ITEM_COLLECTED,
    RES_SND_BOOTS_STOLEN	= RES_SND_BASE + SND_BOOTS_STOLEN,
    RES_SND_TELEPORTING		= RES_SND_BASE + SND_TELEPORTING,
    RES_SND_DOOR_OPENED		= RES_SND_BASE + SND_DOOR_OPENED,
    RES_SND_SOCKET_OPENED	= RES_SND_BASE + SND_SOCKET_OPENED,
    RES_SND_BUTTON_PUSHED	= RES_SND_BASE + SND_BUTTON_PUSHED,
    RES_SND_TILE_EMPTIED	= RES_SND_BASE + SND_TILE_EMPTIED,
    RES_SND_WALL_CREATED	= RES_SND_BASE + SND_WALL_CREATED,
    RES_SND_TRAP_ENTERED	= RES_SND_BASE + SND_TRAP_ENTERED,
    RES_SND_BOMB_EXPLODES	= RES_SND_BASE + SND_BOMB_EXPLODES,
    RES_SND_WATER_SPLASH	= RES_SND_BASE + SND_WATER_SPLASH,
    RES_SND_SKATING_TURN	= RES_SND_BASE + SND_SKATING_TURN,
    RES_SND_BLOCK_MOVING	= RES_SND_BASE + SND_BLOCK_MOVING,
    RES_SND_SKATING_FORWARD	= RES_SND_BASE + SND_SKATING_FORWARD,
    RES_SND_SLIDING		= RES_SND_BASE + SND_SLIDING,
    RES_SND_SLIDEWALKING	= RES_SND_BASE + SND_SLIDEWALKING,
    RES_SND_ICEWALKING		= RES_SND_BASE + SND_ICEWALKING,
    RES_SND_WATERWALKING	= RES_SND_BASE + SND_WATERWALKING,
    RES_SND_FIREWALKING		= RES_SND_BASE + SND_FIREWALKING,
    RES_SND_LAST		= RES_SND_FIREWALKING,

    RES_COUNT		= RES_SND_LAST + 1
};
