...
static tileidinfo const cc2tileidmap[NTILES] = {
    ...
    { Ice,			    10,  1, -1, -1, TILEIMG_SINGLEOPAQUE },
    { IceWall_Southeast,	14,  1, -1, -1, TILEIMG_SINGLEOPAQUE },
    { IceWall_Southwest,	13,  1, -1, -1, TILEIMG_SINGLEOPAQUE },
    { IceWall_Northeast,	12,  1, -1, -1, TILEIMG_SINGLEOPAQUE },
    { IceWall_Northwest,	11,  1, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Gravel,			 9, 10, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Dirt,			     4, 31, -1, -1, TILEIMG_SINGLEOPAQUE },
    ...
    { Burglar,			 3,  2, -1, -1, TILEIMG_SINGLEOPAQUE },
    { HintButton,		 5,  2, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Button_Blue,		 8,  6, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Button_Green,		 9,  6, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Button_Red,		10,  6, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Button_Brown,		11,  6, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Teleport,			 4, 10, -1, -1, TILEIMG_OPAQUECELS },
    { Wall,			     1,  2, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Wall_North,		 1, 10, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Wall_West,		 1, 10, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Wall_South,		 1, 10, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Wall_East,		 1, 10, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Wall_Southeast,	    1,  10, -1, -1, TILEIMG_SINGLEOPAQUE },
    { HiddenWall_Perm,		 0,  2, -1, -1, TILEIMG_SINGLEOPAQUE },
    ...
    { Door_Blue,		 1,  1, -1, -1, TILEIMG_SINGLEOPAQUE },
    { Door_Yellow,		 2,  1, -1, -1, TILEIMG_SINGLEOPAQUE },
    ...
    { Teeth _NORTH,		-1, -1,  0, 11, TILEIMG_CREATURE_3 },
